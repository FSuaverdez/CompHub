      ...
      <div class="modal-content">
        <form action="updateticket.php" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Issue</label>
              <input type="text" name="user-issue" id="user-issue" class="form-control" required>
            </div>
            <div class="form-group">
                  <label>Description</label>
                  <input type="text" name="user-description" id="user-description" class="form-control" required>
            </div>
            <div class="form-group">
                  <label>Date Created</label>
                  <input type="textbox" name="user-date_created" id="user-date_created" class="form-control" required>
            </div>
            <div class="form-group">
                  <label>Date Resolved</label>
                  <input type="textbox" name="user-date_resolved" id="user-date_resolved" class="form-control" disabled>
            </div>
            <div class="form-group">
                  <label>Status</label>
  ...
  <script>
    $(document).ready(function() {
      $('.editbtn').on('click', function() {
        ...
        $('#user-issue').val(data[3]);
        $('#user-description').val(data[4]);
        $("#user-date_created").val(data[5]); 
        $("#user-date_resolved").val(data[6]); 
        $("#user_status option[value="+data[7]+"]").attr("selected", "selected");
